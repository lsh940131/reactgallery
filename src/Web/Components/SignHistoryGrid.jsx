...
export default function EnhancedTable({ historyData }) {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = historyData.map((n) => n.username);
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, historyData.length - page * rowsPerPage);
                ...
                .map((data, index) => {
                  ...
                  return (
                    <TableRow
                      ...
                      tabIndex={-1}
                      key={`${data.Username}_${data.Timestamp}`}
